...
export const products: Product[] = [
  {
    ...
    image: getImagePath('wireless-headphones.jpg'),
    rating: 4.5,
    reviews: 128,
  },
  {
    ...
    image: getImagePath('smart-home-hub.jpg'),
    rating: 4.2,
    reviews: 64,
  },
  {
    ...
    image: getImagePath('4k-monitor.jpg'),
    rating: 4.7,
    reviews: 256,
  },
  {
    ...
    image: getImagePath('organic-cotton-tee.jpg'),
    rating: 4.3,
    reviews: 89,
  },
  {
    ...
    image: getImagePath('running-jacket.jpg'),
    rating: 4.6,
    reviews: 45,
  },
  {
    ...
    image: getImagePath('merino-wool-socks.jpg'),
    rating: 4.4,
    reviews: 112,
  },
  {
    ...
    image: getImagePath('ceramic-vase-set.jpg'),
    rating: 4.8,
    reviews: 37,
  },
  {
    ...
    image: getImagePath('smart-desk-lamp.jpg'),
    rating: 4.5,
    reviews: 73,
  },
];
...
export const categories = [
  {
    ...
    name: 'Electronics',
    count: 3,
    image: getImagePath('category-electronics.jpg'),
  },
  {
    id: 'clothing' as const,
    name: 'Clothing',
    count: 3,
    image: getImagePath('category-clothing.jpg'),
  },
  {
    id: 'home' as const,
    name: 'Home & Living',
    count: 2,
    image: getImagePath('category-home.jpg'),
  },
];
